...
class Shift extends Model
{
    ...
    public function getList(){
        ...
        $user_list = DB::table('user')
            ...
            -> where('is_del','=',0)
            -> paginate(10);
        $shift_last_list = DB::table('shift_last_month_day')
    ...
    public function checkGenerateUser($user_list){
        $time = date('Y-m',time());
        $list = Db::table('shift_last_month_day')
            -> leftJoin('user','user.user_id','=','shift_last_month_day.user_id')
