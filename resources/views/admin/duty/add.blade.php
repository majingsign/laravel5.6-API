  ...
  <body>
    <div class="x-body layui-anim layui-anim-up">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_time" name="ontime" required="" lay-verify="ontime"
    ...
    <script>
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
              ...
              $.ajax({
                  url:"{{route('admin.duty.addDuty')}}",
                  type:"post",
                  data:{name:data.field.name,type:data.field.type,ontime:data.field.ontime,_token:token},
                  dataType:"json",
