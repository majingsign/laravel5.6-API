...
<div style="display: flex;align-items: center;">
    <div style="flex: 0.8">
        <div style="margin-top: 20px;font-size: 12px;">
            ...
            @foreach($type_list as $type)
                ...
                @elseif($type -> name == "E")
                    <span style="color: rgb(232, 14, 14);"> {{$type -> name}} {{$type -> on_time}}&nbsp;&nbsp;</span>
                    @endif
    ...
    <div class="layui-row" style="display: flex">
        <div>
            @if($is_old == 1)
                <a href="{{route('admin.changeinverted.discardedgenerate')}}">
        ...
        <div style="margin-left: 50px;">
            <a href="{{route('admin.changeinverted.nextrexcelport')}}">
                   ...
                   @foreach($user['work'] as $work)
                       @if($work == '休')
                        <td style="color: #66666682;" class="show_td">{{$work}}</td>
                           @elseif($work == 'C1')
                        <td   style="color: rgb(34, 144, 78)" class="show_td">{{$work}}</td>
                    @elseif($work == 'C2')
                        <td style="color: rgb(193, 195, 14)" class="show_td">{{$work}}</td>
                    @elseif($work == 'C4')
                        <td style="color: rgb(27, 121, 242)" class="show_td">{{$work}}</td>
                    @elseif($work == 'D1')
                        <td style="color: rgb(209, 27, 242)" class="show_td">{{$work}}</td>
                           @else
                               <td  class="show_td" style="color: rgb(232, 14, 14);font-weight: bold;">{{$work}}</td>
                           @endif
        ...
        $('td').dblclick(function(){
          var text = $(this).text();
            ...
            if(text == 'C1'){
                ...
                str += ' <option value="C1" >C1</option><option value="C2" >C2</option><option value="C4">C4</option><option value="D1" >D1</option><option>E</option><option>休</option><option value=""  selected="selected">请假或离职</option>';
            }
            str += ' </select>\
                </div>\
                </div>\
